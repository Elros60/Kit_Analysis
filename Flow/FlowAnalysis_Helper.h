...
public:
  ...
  void
  PlotSystematics(double ptmin, double ptmax, double centmin, double centmax,
                  int nBins, int index, TCanvas *c_sys_yield, TCanvas *c_sys_v2,
                  ...
                  int nbCombo_yield, int nbCombo_v2, vector<double> stats_yield,
                  vector<double> stats_v2, vector<double> stats_meanPt,
                  double *pt_bins, TList *ls_sys_yield, TList *ls_sys_v2,
                  TList *ls_sys_meanPt, bool Save, std::string flag = "pt");
  void PlotSystematicsNoMeanPt(
      ...
      TList *ls_sys_yield, TList *ls_sys_v2, bool Save,
      std::string flag = "pt");
